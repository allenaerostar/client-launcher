...
class LoginBonusRewards(TestCase):
    def setUp(self):
        models.LoginBonusRewards.objects.create(reward_num=25, item_id=5, item_name="Onyx Apple", quantity=5, time_to_expire=7200000)

    def test_loginbonusrewards_creation(self):
        login_bonus_reward = models.LoginBonusRewards.objects.get(reward_num=25)
        self.assertTrue(isinstance(login_bonus_reward, models.LoginBonusRewards))
        self.assertTrue(login_bonus_reward.reward_num == 25)
