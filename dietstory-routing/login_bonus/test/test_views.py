...
class RewardsViewTest(TestCase):
    ...
    def setUp(self):
        login_bonus.models.LoginBonusRewards.objects.create(reward_num=1, item_id=5, item_name="Onyx Apple", quantity=5,
                                        time_to_expire=7200000)
        login_bonus.models.LoginBonusRewards.objects.create(reward_num=2, item_id=6, item_name="Cheese Cookie", quantity=5,
                                            time_to_expire=7200000)
